          ...
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form role="form" action="<?= BASEURL?>/login/prosesLogin" method="post">

                  <div class="d-flex align-items-center mb-3 pb-1">
                    <i class="fas fa-cubes fa-2x" style="color: #ff6219;"></i>
                    <span class="h1 fw-bold mb-0">HaloDek</span>
                  </div>
                  ...
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an account? <a href="<?= BASEURL?>/user/tambah"
